...
var GoogleStorageService = (function () {
  ...
  GoogleStorageService.prototype.upload = function (directory, name, data) {
    var _this = this;
    var key = name;
  ...
  GoogleStorageService.prototype.delete = function (directory, filename) {
    var key = filename;
    if (directory && directory.length > 0) {
